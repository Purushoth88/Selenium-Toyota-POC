...
public class Base64Coder {
	...
	/**
	 * @summary - This method encodes and decodes two strings using the other
	 *          methods in this class. The intent is to encode strings in such a
	 *          way that they can be decoded in the test suite, ideally having
	 *          been pulled from a properties file.
	 */
	@Test
	public void endcodeString() {
