...
public class TestReporter {
	...
	/*
	 * public static void logScenario(){ Reporter.log(
	 * "<br/><b><font size = 4>Data Scenario: " +
	...
	public static void logScreenshot(WebDriver driver, String fileLocation, String slash, String runLocation) {
		...
		if (runLocation.equalsIgnoreCase("remote")) {
			...
			// fileLocation =
			// fileLocation.replace("/var/lib/jenkins/jobs/OpenSandbox/jobs/Toyota-SauceLabs/workspace/",
			// "job/OpenSandbox/job/Toyota-SauceLabs/230/testngreports/toyota/TestAllSecondaryNavigations/");
