...
public class RestService {
	...
	/**
	 * Sends a post (update) request, pass in the parameters for the json
	 * arguments to update
	 * 
	 * @param URL
	 *            for the service
	...
	/**
	 * Sends a put (create) request, pass in the parameters for the json
	 * arguments to create
	 * 
	 * @param URL
	 *            for the service
	...
	/**
	 * Sends a patch (update) request, pass in the parameters for the json
	 * arguments to update
	 * 
	 * @param URL
	 *            for the service
	...
	/**
	 * Sends an options request. Options should give what the acceptable methods
	 * are for the service (GET, HEAD, PUT, POST, etc). There should be some
	 * sort of an ALLOW header that will give you the allowed methods. May or
	 * may not be a body to the response, depending on the service.
	 * 
	 * This method will return all the headers and the test should parse through
	 * and find the header it needs, that will give the allowed methods, as the
	 * naming convention will be different for each service.
	 * 
	 * @param URL
	 *            for the service
