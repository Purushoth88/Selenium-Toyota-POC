...
public class MainNavigation extends Page{
	...
	@FindBy(xpath = MainNavigationElements.YOURLOCATION)
	private Button btnYourLocation;
	
	//ZIP Code Popup
	@FindBy(id = MainNavigationElements.ZIPCODE_POPUP)
	private Element eleZipCodePopup;
	
	//ZIP Code Popup Body
	@FindBy(xpath = MainNavigationElements.ZIPCODE_MAINBODY)
	private Element eleZipCodePopupBody;
	
	//ZIP Code textbox
	@FindBy(xpath = MainNavigationElements.ZIPCODE_EDITFIELD)
	private Textbox txtZipCode;
	
	//Actual ZIP Code Value element
	@FindBy(xpath = MainNavigationElements.ZIPCODE)
	...
	public void changeZipCodes(@Parameter String zipCode){
		...
		modifiedZipCode = captureCurrentZipCode();
