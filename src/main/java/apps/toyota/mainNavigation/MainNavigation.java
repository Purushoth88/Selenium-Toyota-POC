...
/**
 * @summary Contains the methods & objects for the Toyota.com Main Navigation
 *          Bar
...
public class MainNavigation extends com.orasi.utils.TestEnvironment {
	...
	// ZIP Code textbox
	// @FindBy(xpath =
	// "//*[@id=\"tcom-nav-zip-flyout\"]/div/div/div[2]/div/input")
	...
	/**
	 * @summary: if the zipcode is different than that found in the UI, this
	...
	public void changeZipCodes(@Parameter String zipCode) {
		...
		// Determine if the existing zipcode in the UI is the same as the
		// zipcode to be used in the test
