 ...
 * @version Created 06/08/2015
 * @author Sam Bridge
 */
public class BuyAToyota_main extends Page{
	
	public static final String BUYATOYOTA_MAIN = "http://www.buyatoyota.com/";
...
//	int loopCounter = 0;
	 ...
	 * 
	 */
	public BuyAToyota_main(WebDriver driver) {
        this.driver = driver;
        navigateTo(BUYATOYOTA_MAIN);
//		super(te);
